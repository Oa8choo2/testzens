...
Software can be classified based on the research it is used for.

- bioinformatics: genetic analysis
- chemistry:
- engineering: fluids
- statistics: R
...
Some software is free, gratis for other software someone has to pay before you
can use it:
